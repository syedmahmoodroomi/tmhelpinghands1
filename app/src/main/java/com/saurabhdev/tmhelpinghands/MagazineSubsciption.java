...
public class MagazineSubsciption extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magazine_subsciption);
        ...
        webView.loadUrl("https://tanzeemulmakatib.org/donate/urdu-magazine/");
