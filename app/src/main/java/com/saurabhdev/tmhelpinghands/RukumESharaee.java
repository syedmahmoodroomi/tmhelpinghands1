...
public class RukumESharaee extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rukum_e_sharaee);
        ...
        webView.loadUrl("https://tanzeemulmakatib.org/donate/rukum-e-sharee-2/");
