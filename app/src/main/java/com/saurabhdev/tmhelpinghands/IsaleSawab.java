...
public class IsaleSawab extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isale_sawab);
        ...
        webView.loadUrl("https://tanzeemulmakatib.org/donate/issal-e-sawab/");
