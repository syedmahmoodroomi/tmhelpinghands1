...
public class IjarahServices extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ijarah_services);
        ...
        webView.loadUrl("https://tanzeemulmakatib.org/donate/ijarah/");
