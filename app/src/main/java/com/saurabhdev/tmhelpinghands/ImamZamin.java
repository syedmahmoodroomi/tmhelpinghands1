...
public class ImamZamin extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_imam_zamin);
        ...
        webView.loadUrl("https://tanzeemulmakatib.org/donate/imam-zamin-2/");
