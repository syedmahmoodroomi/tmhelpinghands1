...
public class DonationsGeneral extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_support_tanzeem);
        ...
        webView.loadUrl("https://tanzeemulmakatib.org/donate/donation-normal/");
