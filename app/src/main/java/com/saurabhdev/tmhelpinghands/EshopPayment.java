...
public class EshopPayment extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eshop_payment);
        ...
        webView.loadUrl("https://tanzeemulmakatib.org/donate/e-shop-payment-2/");
