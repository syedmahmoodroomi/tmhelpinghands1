...
public class TameeraatFund extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tameeraat_fund);
        ...
        webView.loadUrl("https://tanzeemulmakatib.org/donate/tameeraat-fund-2/");
