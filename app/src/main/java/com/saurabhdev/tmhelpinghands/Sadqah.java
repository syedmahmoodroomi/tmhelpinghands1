...
public class Sadqah extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sadqah);
        ...
        webView.loadUrl("https://tanzeemulmakatib.org/donate/donation-page-test/");
