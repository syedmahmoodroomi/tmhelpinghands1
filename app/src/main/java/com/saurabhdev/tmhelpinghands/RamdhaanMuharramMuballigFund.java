...
public class RamdhaanMuharramMuballigFund extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ramdhaan_muharram_muballig_fund);
        ...
        webView.loadUrl("https://tanzeemulmakatib.org/donate/muballig-fund/");
