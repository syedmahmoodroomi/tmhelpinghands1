...
public class JoinHandsWithUs extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_join_hands_with_us);
        ...
        webView.loadUrl("https://tanzeemulmakatib.org/donate/2048-2/");
